            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  minLength={6}
                  className="w-full border-2 border-black px-4 py-3 pr-12 font-kanit text-sm focus:outline-none focus:border-yellow-DEFAULT transition-colors duration-150 placeholder:text-black/30"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((v) => !v)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-black/40 hover:text-black transition-colors duration-150"
                  tabIndex={-1}
                >
                  {showPassword ? (
